        ...
        <div className="flex-1 text-center md:text-left flex flex-col items-center md:items-start">
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-center mb-6">
            <a
              href="/resume.pdf"
              download
              className="bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold py-4 px-10 rounded-md shadow-lg hover:from-blue-600 hover:to-blue-800 transition text-xl border-2 border-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300/50 flex items-center gap-3 transform hover:scale-105"
            >
