      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 text-center md:text-left flex flex-col items-center md:items-start">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 text-black">
            Hi, I am <span>Rochan Vardhan Boddepalli</span>
          </h1>
          <p className="text-2xl sm:text-3xl text-gray-700 italic mb-10 font-light leading-relaxed max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-center mb-6">
            <a
              href="/resume.pdf"
              download
              className="bg-[#b3b29b] text-white font-semibold py-4 px-10 rounded-md shadow-lg hover:bg-[#a3a28b] transition text-xl border-2 border-[#b3b29b] focus:outline-none focus:ring-4 focus:ring-[#b3b29b]/50 flex items-center gap-3 transform hover:scale-105"
            >
          ...
          <div className="flex gap-8 mt-2">
            <a href="https://github.com/Rochan09" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <svg className="w-10 h-10 text-gray-700 hover:text-black transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://linkedin.com/in/rochan-vardhan-boddepalli" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg className="w-10 h-10 text-gray-700 hover:text-blue-600 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
