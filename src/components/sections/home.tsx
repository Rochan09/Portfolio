    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12">
        ...
        <div className="flex-1 text-center md:text-left">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 text-black dark:text-white transition-colors duration-300">
            Hello, I'm <span>Rochan Vardhan Boddepalli</span>
          </h1>
          <p className="text-2xl sm:text-3xl text-gray-700 dark:text-gray-300 italic mb-6 font-light leading-relaxed max-w-xl transition-colors duration-300">
            "Turning ideas into reality, one line of code at a time."
          </p>
          <h2 className="text-xl sm:text-2xl text-blue-700 dark:text-blue-400 font-semibold mb-10 transition-colors duration-300">
            <Typewriter />
          </h2>
          <div className="flex flex-col sm:flex-row gap-6 items-center mb-6">
            <a
              href="#projects"
              className="inline-flex items-center gap-3 px-8 py-3 rounded-xl font-semibold text-lg text-gray-900 dark:text-gray-100 bg-gray-200 dark:bg-gray-700 border border-gray-400 dark:border-gray-600 shadow transition-all duration-200 hover:shadow-lg hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none"
            >
            ...
            <a
              href="/resume.pdf"
              download="Rochan_Vardhan_Resume.pdf"
              className="inline-flex items-center gap-3 px-8 py-3 rounded-xl font-semibold text-lg text-white bg-blue-600 dark:bg-blue-700 border border-blue-700 dark:border-blue-800 shadow transition-all duration-200 hover:shadow-lg hover:bg-blue-700 dark:hover:bg-blue-800 focus:outline-none"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
          ...
          <div className="flex gap-8 mt-2">
            <a href="https://github.com/Rochan09" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
              className="transition-transform duration-300 hover:scale-110 hover:shadow-2xl rounded-full bg-white dark:bg-gray-800 p-1 shadow-md dark:shadow-gray-900/50">
              <svg className="w-10 h-10 text-gray-800 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://linkedin.com/in/rochan-vardhan-boddepalli" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              className="transition-transform duration-300 hover:scale-110 hover:shadow-2xl rounded-lg bg-white dark:bg-gray-800 p-1 shadow-md dark:shadow-gray-900/50">
